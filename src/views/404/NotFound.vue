<template>
  <div class="flex h-screen items-center justify-center bg-gradient-to-br from-background to-muted">
    <div class="text-center">
      <div class="mb-8">
        <h1 class="text-8xl font-bold text-primary">404</h1>
        <p class="mt-2 text-2xl font-semibold text-foreground">页面未找到</p>
      </div>
      <p class="mb-8 text-lg text-muted-foreground">抱歉，您访问的页面不存在或已被删除。</p>
